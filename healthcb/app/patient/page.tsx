...
function Patient() {
  ...
  const fetchPatientInfo = async () => {
    ...
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/profile/`,
    //     {
    //       headers: {
  ...
  const fetchNotifications = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/notifications/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  const fetchUpcomingEvents = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/upcoming-events/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  const fetchUpcomingConsultations = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/upcoming-consultations/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  const fetchHealthMetrics = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/health-metrics/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  const fetchMedications = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/medications/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  const fetchAppointments = async () => {
    // try {
    //   const response = await axios.get(
    //     `${process.env.NEXT_PUBLIC_API_URL_PROD}/api/patient/appointments/`,
    //     {
    //       headers: {
    //         'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //       }
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute left-1/2 top-0 h-full w-[800px] -translate-x-1/2 opacity-40" viewBox="0 0 800 800" preserveAspectRatio="none">
          <motion.path
            d="M100,0 C400,200 400,600 100,800 M700,0 C400,200 400,600 700,800"
            fill="none"
            stroke="#79CEED"
            strokeWidth="3"
          ...
          />
          <motion.path
            d="M200,0 C500,200 500,600 200,800 M600,0 C300,200 300,600 600,800"
            fill="none"
            stroke="#06AFEC"
            strokeWidth="2"
            initial={{ pathLength: 0 }}
          ...
          />
          <motion.path
            d="M150,0 C450,200 450,600 150,800 M650,0 C350,200 350,600 650,800"
            fill="none"
            stroke="#ABF600"
            strokeWidth="2"
            initial={{ pathLength: 0 }}
          ...
          />
          <motion.path
            d="M300,0 C600,200 600,600 300,800 M500,0 C200,200 200,600 500,800"
            fill="none"
            stroke="#79CEED"
            strokeWidth="1.5"
            initial={{ pathLength: 0 }}
      ...
      <div className="container mx-auto px-6 pt-8 relative z-10">
        ...
        >
          <div>
            ...
            >
              Welcome, {localStorage.getItem('first_name') || 'Patient'}
            </motion.h1>
            <motion.p 
              initial={{ x: -20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <span className="font-medium text-[#1A202C] group-hover:text-blue-600 transition-colors">Profile</span>
              </motion.button>
            </div>
            <motion.button 
