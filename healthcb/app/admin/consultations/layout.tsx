...
import { ArrowLeft, Calendar, ClipboardList, Home, Video } from 'lucide-react';
    ...
    <main className="min-h-screen bg-[#FFFFFF] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-8 relative z-10">
        ...
        <div className="flex space-x-1 mb-8 border-b">
          ...
          <Link
            href="/admin/consultations/requests"
            className={`flex items-center gap-2 px-4 py-2 rounded-t-lg ${
              isActive('/admin/consultations/requests')
                ? 'bg-[#ABF600] text-[#1A202C] font-medium'
                : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
          ...
          <Link
            href="/admin/consultations/rooms"
            className={`flex items-center gap-2 px-4 py-2 rounded-t-lg ${
              isActive('/admin/consultations/rooms')
                ? 'bg-[#ABF600] text-[#1A202C] font-medium'
                : 'text-gray-600 hover:bg-gray-100'
            }`}
          >
